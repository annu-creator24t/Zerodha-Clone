            ...
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <h2 className='fs-4'>The Zerodha Universe</h2>
                     <p className='text-muted'>No just an app,but a whole ecosystem ,Our investments in 30+ fintech startups offer you tailored services specific to your needs.</p>
